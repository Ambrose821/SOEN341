    ...
    <div className="Checkin">
      ...
      <form onSubmit={handleForm2Submit} className="form">
        ...
        <label htmlFor="checkbox_option">
          Vehicle is Undamaged (Required if text box is empty)
        </label>
        <br />
        <br />
      ...
      <h3>
        <u>Sign Rental agreement:</u>
      </h3>
      <button
        onClick={sendToAgreement}
        disabled={!isForm1Submitted || !isForm2Submitted || !depositPaid}
      >
        Electronically
      </button>
      <Link to="/agreementp">

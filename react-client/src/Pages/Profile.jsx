...
const Profile = () => {
  ...
  const [profileCurrentUserFirstName, setProfileCurrentUserFirstName] =
    useState(currentUserFirstName);
  const [profileCurrentUserLastName, setProfileCurrentUserLastName] =
    useState(currentUserLastName);
  const [profileCurrentUserFlag, setProfileUserFlag] =
    useState(currentUserFlag);
    ...
    <div>
      ...
      <div>
        ...
        {profileCurrentUserFirstName && (
          <p>First Name: {profileCurrentUserFirstName}</p>
        )}
        {profileCurrentUserLastName && (
          <p>Last Name: {profileCurrentUserLastName}</p>
        )}
